...
**UFW Command**
*Description*: UFW is a user friendly command-line tool that helps you enable, disable, and configure firewall rules on Debian. It controls what network traffic is allowed or denied

**Formula/Syntax**: `sudo ufw allow OpenSSH`
...
- Explanation: Allows web traffic on ports 80(HTTP) and 443 (HTTPS), enabling Apache to work properly.
...
- /ete/apache2/sites-available/
- - Stores site (virtual host) configs available but not enabled
